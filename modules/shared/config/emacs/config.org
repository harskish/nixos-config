...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Erik Härkönen"
    user-mail-address "erik.harkonen@hotmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/erik/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/erik/bin" "/profile/bin" "/Users/erik/.npm-packages/bin" "/Users/erik/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
